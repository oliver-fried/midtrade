...
const ApparelCards = () => {
    ...
    useEffect(() => {
        ...
        const batch = query(collection(db, "posts/"), orderBy("postTime", "desc"), limit(7), where("category", "==", "3"));
    ...
    const searchPrice = () => {
        ...
        const batch = query(collection(db, "posts/"), orderBy("priceNum"), limit(7), where("priceNum", "!=", 0), where("category", "==", "3"));
    ...
    const handleSearch = (e) => {
        ...
        var batch = query(collection(db, "posts/"), orderBy("postTime"), limit(7), where("postDescCombined", "array-contains", search), where("category", "==", "3"));

        if(!searchByTime) {
            batch = query(collection(db, "posts/"), orderBy("priceNum"), limit(7), where("postDescCombined", "array-contains", search), where("priceNum", "!=", 0), where("category", "==", "3"));
        }
    ...
    const fetchMorePosts = (key) => {
        ...
        const batchNoSearch = query(collection(db, "posts/"), limit(7), orderBy("postTime", "desc"), startAfter(key), where("category", "==", "3"));
        const batchSearch = query(collection(db, "posts/"), orderBy("postTime"), limit(7), startAfter(key), where("postDescCombined", "array-contains", search), where("category", "==", "3"));
        const batchSearchByPrice = query(collection(db, "posts/"), orderBy("priceNum"), limit(7), startAfter(key), where("postDescCombined", "array-contains", search), where("priceNum", "!=", 0), where("category", "==", "3"));
        const batchNoSearchByPrice = query(collection(db, "posts/"), limit(7), orderBy("priceNum"), startAfter(key), where("priceNum", "!=", 0), where("category", "==", "3"));
