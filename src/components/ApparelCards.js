...
const ApparelCards = () => {
    ...
    useEffect(() => {
        ...
        const batch = query(collection(db, "posts/"), orderBy("postTime", "desc"), limit(20), where("category", "==", "3"));
    ...
    const searchPrice = () => {
        ...
        const batch = query(collection(db, "posts/"), orderBy("priceNum"), limit(20), where("priceNum", "!=", 0), where("category", "==", "3"));
    ...
    const handleSearch = (e) => {
        ...
        var batch = query(collection(db, "posts/"), orderBy("postTime"), limit(20), where("postDescCombined", "array-contains", search), where("category", "==", "3"));

        if(!searchByTime) {
            batch = query(collection(db, "posts/"), orderBy("priceNum"), limit(20), where("postDescCombined", "array-contains", search), where("priceNum", "!=", 0), where("category", "==", "3"));
        }
    ...
    const fetchMorePosts = (key) => {
        ...
        const batchNoSearch = query(collection(db, "posts/"), limit(20), orderBy("postTime", "desc"), startAfter(key), where("category", "==", "3"));
        const batchSearch = query(collection(db, "posts/"), orderBy("postTime"), limit(20), startAfter(key), where("postDescCombined", "array-contains", search), where("category", "==", "3"));
        const batchSearchByPrice = query(collection(db, "posts/"), orderBy("priceNum"), limit(20), startAfter(key), where("postDescCombined", "array-contains", search), where("priceNum", "!=", 0), where("category", "==", "3"));
        const batchNoSearchByPrice = query(collection(db, "posts/"), limit(20), orderBy("priceNum"), startAfter(key), where("priceNum", "!=", 0), where("category", "==", "3"));
