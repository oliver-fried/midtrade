...
const BookCards = () => {
    ...
    useEffect(() => {
        ...
        const batch = query(collection(db, "posts/"), orderBy("postTime", "desc"), limit(7), where("category", "==", "1"));
    ...
    const searchPrice = () => {
        ...
        const batch = query(collection(db, "posts/"), orderBy("priceNum"), limit(7), where("priceNum", "!=", 0), where("category", "==", "1"));
    ...
    const handleSearch = (e) => {
        ...
        var batch = query(collection(db, "posts/"), orderBy("postTime"), limit(7), where("postDescCombined", "array-contains", search), where("category", "==", "1"));

        if(!searchByTime) {
            batch = query(collection(db, "posts/"), orderBy("priceNum"), limit(7), where("postDescCombined", "array-contains", search), where("priceNum", "!=", 0), where("category", "==", "1"));
        }
    ...
    const fetchMorePosts = (key) => {
        ...
        const batchNoSearch = query(collection(db, "posts/"), limit(7), orderBy("postTime", "desc"), startAfter(key), where("category", "==", "1"));
        const batchSearch = query(collection(db, "posts/"), orderBy("postTime"), limit(7), startAfter(key), where("postDescCombined", "array-contains", search), where("category", "==", "1"));
        const batchSearchByPrice = query(collection(db, "posts/"), orderBy("priceNum"), limit(7), startAfter(key), where("postDescCombined", "array-contains", search), where("priceNum", "!=", 0), where("category", "==", "1"));
        const batchNoSearchByPrice = query(collection(db, "posts/"), limit(7), orderBy("priceNum"), startAfter(key), where("priceNum", "!=", 0), where("category", "==", "1"));
