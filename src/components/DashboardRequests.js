...
function DashboardRequests(props) {
         ...
         <div class="row align-items-center my-5">
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <a href="/dashboard" class={`btn ${
                  (props.location.pathname === "/dashboard" | props.location.pathname === "/dashboard-posts") ? "btn-primary" : "btn-outline-primary"
                }`}>
               Selling</a>
...
export default withRouter(DashboardRequests);